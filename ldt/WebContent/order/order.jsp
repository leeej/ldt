...
<html lang="ko">
	<head>
		...
		<body class="header-page  wsite-page-index  wsite-theme-light">
			<div id="header">
				<div class="container-top" style="margin-left:10px; margin-right:10p">
					<div class="logo">
						<span class="wsite-logo">
							<a href="">
								<img src="/order/files/logo1.jpg" alt="LOTTERIA"/>
							</a>
						</span>
					</div>
				</div>
						...
						<div id="main">
							<div id="wsite-content" class="wsite-elements wsite-not-footer">
								<div class="wsite-section-wrap">
									<div class="wsite-section wsite-body-section wsite-section-bg-color wsite-background-11 wsite-custom-background" style="height: auto;background-color: #FFFFFF;
			background-image: none;
			is_customized: 1;">
										<div class="wsite-section-content">
											<div class="container">
												<div class="wsite-section-elements" style="margin-top:20px">
													<h2 style="text-align:center;">
														<font size="3" style="font-weight:bold">${sessionScope.user.getUser_id() }(${sessionScope.user.getUser_name() })님 어서오세요.</font>
													</h2>
													<h2 style="text-align:center;">
														<font size="6">
															<strong>메뉴</strong>
																					...
																					<div>
																						<div class="wsite-image wsite-image-border-none " style="padding-top:0px;padding-bottom:0px;margin-left:0px;margin-right:0px;text-align:center">
																							<h2 class="wsite-content-title" style="text-align:center;">
																								<font size="4" style="font-weight:bold">${recommend_menu.getMenu_name() }</font>
																							</h2>
																							<a>
																			...
																			<tbody class="wsite-multicol-tbody">
																				<tr class="wsite-multicol-tr">
																					...
																					<td class="wsite-multicol-col" style="width:50%; padding:0 15px;">
																						<div>
																							<div class="wsite-image wsite-image-border-none " style="padding-top:0px;padding-bottom:0px;margin-left:0px;margin-right:0px;text-align:center">
																								<h1 class="wsite-content-title" style="text-align:center;">
													...
													<form id="form-646132443274734859">
														<div id="646132443274734859-form-parent" class="wsite-form-container" style="margin-top:0px;">
															<ul class="formlist" id="646132443274734859-form-list">
																<h2 class="wsite-content-title" style="text-align:center;">
																	<strong>
																		<font size="4">주문서 작성</font>
																	</strong>
																</h2>
																<div>
																	<div style="height: 0px; overflow: hidden; width: 0px;"></div>
																				...
																				<tbody class="wsite-multicol-tbody">
																					<tr class="wsite-multicol-tr">
																						<td class="wsite-multicol-col" style="width:34.377097748978%; padding:0 15px;">
																							<div>
																								<div class="wsite-form-field" style="margin:0px 0px 0px 0px;">
																									<label class="wsite-form-label" for="input-598954364540785139" style="font-weight:bold">메뉴선택
																										<span class="form-required">*</span>
																									</label>
																									<div class="wsite-form-radio-container">
																										<select id="selected_menu" style="width:100%;">
																											<option value='메뉴'>메뉴</option>
																											<c:forEach var="menu" items="${menus}">
																											<c:choose>
																											<c:when test="${!empty recommend_menu && (recommend_menu == menu)}">
																												<option value="${menu.getMenu_id() }" selected>${menu.getMenu_name() }</option>
																											</c:when>
																											<c:otherwise>
																						...
																						<td class="wsite-multicol-col" style="width:34.377097748978%; padding:0 15px;">
																							<div>
																								<div class="wsite-form-field" style="margin:0px 0px 0px 0px;">
																									<label class="wsite-form-label" for="orderQuantity" style="font-weight:bold">개수
																										<span class="form-required">*</span>
																									</label>
																									<div class="wsite-form-input-container">
																										<!-- 개수 타입 -->
																										<input aria-required="true" style="width:100%;" id="quantity" class="wsite-form-input wsite-input " type="number" name="_u615700272928674583"/>
																									</div>
																								...
																								<div class="wsite-form-field" style="margin:0px 0px 0px 0px;">
																									...
																									<div class="wsite-form-radio-container">
																										<span class='form-radio-container'>
																											<p align="right">
																												<button type='button' id='btnAdd' class="btn btn-danger">메뉴 추가</button>
																											</p>
																										</span>
																									</div>
																						...
																						<c:if test="${!empty sessionScope.cart }">
																							<td class="wsite-multicol-col" style="width:32.011166387729%; padding:0 15px;">
																								<div>
																									<div class="wsite-form-field" style="margin:0px 0px 10px 0px;">
																										<h2>
																											<label class="wsite-form-label" for="orderDetail" style="font-weight:bold"><주문내역>
																												<span class="form-not-required">*</span>
																											</label>
																										</h2>
																										<div class="wsite-form-input-container">
																											<%-- <textarea id="orderDetail" class="wsite-form-input wsite-input wsite-input-width-285px" name="_u249932526256207960" style="height: 50px">
																												<c:forEach var="menu" items="${menus }">
																													<c:if test="${!empty sessionScope.cart.get(menu) }">${menu.getMenu_name() } - ${sessionScope.cart.get(menu) }개</c:if>
																												</c:forEach>
																											</textarea> --%>
																											<label id="orderDetail" class="wsite-form-label" name="_u249932526256207960" style="height: 50px">
																												<c:forEach var="menu" items="${menus }">
																													<c:if test="${!empty sessionScope.cart.get(menu) }">
																														<div>
																															${menu.getMenu_name() } - ${sessionScope.cart.get(menu) }개
																														</div>
																													</c:if>
																												</c:forEach>
																											</label>
														...
														<c:if test="${!empty sessionScope.cart }">
															...
															<div style="text-align:right; margin-top:10px; margin-bottom:0px;">
																<a>
																	<button class="wsite-button; btn btn-danger" style="padding-left:25px; padding-right:25px; padding-top:5px; padding-bottom:5px;" type="button" id="btnOrder">주 문</button>
																</a>
															</div>
														</c:if>
													</form>
